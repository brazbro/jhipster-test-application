package net.besterman.jhipster.web.rest;

import static net.besterman.jhipster.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.besterman.jhipster.IntegrationTest;
import net.besterman.jhipster.config.Constants;
import net.besterman.jhipster.domain.User;
import net.besterman.jhipster.repository.AuthorityRepository;
import net.besterman.jhipster.repository.UserRepository;
import net.besterman.jhipster.security.AuthoritiesConstants;
import net.besterman.jhipster.service.UserService;
import net.besterman.jhipster.service.dto.AdminUserDTO;
import net.besterman.jhipster.service.dto.PasswordChangeDTO;
import net.besterman.jhipster.service.dto.UserDTO;
import net.besterman.jhipster.web.rest.vm.KeyAndPasswordVM;
import net.besterman.jhipster.web.rest.vm.ManagedUserVM;
