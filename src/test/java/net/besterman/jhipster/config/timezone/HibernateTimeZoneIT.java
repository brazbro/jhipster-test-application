package net.besterman.jhipster.config.timezone;
...
import net.besterman.jhipster.repository.timezone.DateTimeWrapper;
import net.besterman.jhipster.repository.timezone.DateTimeWrapperRepository;
